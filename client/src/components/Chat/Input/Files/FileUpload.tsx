...
const FileUpload: React.FC<FileUploadProps> = ({
  ...
  return (
    <label
      ...
      className={cn(
        'mr-1 flex h-auto cursor-pointer items-center rounded bg-transparent px-2 py-1 text-xs font-normal transition-colors hover:bg-gray-100 hover:text-secondary dark:bg-transparent dark:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-primary',
        statusColor,
        containerClassName,
      )}
    >
